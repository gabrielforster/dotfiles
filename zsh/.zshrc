...
PATH=$PATH PATH=$HOME/bin:/usr/local/bin:$PATH PATH=$PATH:$HOME/.asdf/installs/rust/1.71.0/bin PATH=$PATH:$HOME/.asdf/installs/golang/1.20.6/packages/bin/ 
PATH=$PATH:$HOME/.asdf/installs/python/3.12.1/bin PATH=$PATH:$HOME/neovim/bin
...
alias sim-app='cd ~/github/adapcon/simplificamais-app/' alias personal='cd ~/github/personal'

alias ts='~/.config/scripts/tmux-sessionier.sh' alias fehbg='~/.config/scripts/fehbg' alias monitor="~/.config/scripts/monitor.sh"

alias python=python3 alias vim=nvim

alias stage="cp $HOME/adapcon/keys/simplificamais-stage.txt $HOME/.aws/credentials" alias prod="cp $HOME/adapcon/keys/simplificamais-prod.txt $HOME/.aws/credentials"
